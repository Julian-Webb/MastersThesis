...
In \cref{fig:qualifications_flow_chart}, we saw that even when seizures and \glspl{fp} were phase locked with features and model performance was acceptable, for only \SI{4}{\percent} of patient-model-feature combinations did \glspl{fp} have a phase preference significantly similar to seizures, as tested with the permutation test.
...
We also saw that \SI{96}{\percent} of combinations exhibited significant phase locking, which is puzzling in cases where seizures did not phase lock.
