...
\section{Interpretation and Implications of Results}\label{sec:interpretation-and-implications-of-results}

\subsection{Model Performance}\label{subsec:discussion-model-performance}
The model's performance decrease on the train vs.\ test set may be explained either by overfitting to the training set or by non-stationarity of distributions in the train vs.\ test set.
...
The lower compute cost paired with the better performance of the \gls{cnn} here thus make it the better model in this analysis.

\subsection{Cycle Extraction}\label{subsec:discussion-cycle-extraction}
