...
\begin{itemize}
    ...
    \item \textbf{Pre-ictal Interval}: This is the critical window immediately preceding a seizure (often defined as the 5 to 60 minutes prior to onset) where the brain undergoes a transition in dynamics. It is believed to hold predictive markers, as an increasing number of critical interactions among neurons in the focal region unfold over time. Signal properties such as accumulated energy and spectral edge frequency often show distinctive trends during this phase as the brain approaches a "critical mass" for ictogenesis.
    \item \textbf{Post-ictal Interval}: This period follows the seizure offset, typically lasting around five minutes, during which the brain recovers from the ictus. EEG signals during this state may show abnormal excitement or depressed activity as physiological functions return to baseline.
