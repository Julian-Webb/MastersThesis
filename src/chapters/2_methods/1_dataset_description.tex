...
Data from two different datasets called ``Ultra2'' (U) and ``Competition'' (C) are used.
Patients are referred to with the initial letter of their dataset, followed by their ID, e.g., U01.
