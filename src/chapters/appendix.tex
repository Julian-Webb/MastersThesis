...
\foreach \ptnt in \patientList{
    \foreach \eventType in \eventTypes{
        \begin{figure}[!ht]
            ...
            \label{fig:phase-histogram-\ptnt-\eventType}
        \end{figure}
    }
}
...
For each feature, we can see the original feature over t`ime (original signal) and the filtered signal, after using the non-causal filter, as explained in \cref{subsec:cycle-filtering}.
...
\foreach \ptnt in \patientList{
    ...
    \foreach \feature in \featureNames{
        \begin{figure}[!ht]
            ...
            \label{fig:filtered-feature-\ptnt-\feature}
        \end{figure}
    }
